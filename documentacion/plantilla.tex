...
En la tabla \ref{resultados_algunas_bd} podemos ver algunos resultados obtenidos al ejecutar nuestras tres variantes de algoritmos genéticos sobre algunas de las bases de datos que se proporcionan en la práctica.
